...
import './App.css';
// Consulta resultado de examen de laboratorio, enlaza a resumtadoe.js
function consultae() {
  return (
  <body>
    <header>
    ...
    <div class="container"> 
      <div class="row p-3 mb-2 bg-info text-dark">
          <div class="col-md-12 col-lg-4 mx-auto">
              ...
              <form action="">
                  <div class="d-grid gap-2 d-md-block">
                     <button class="btn btn-primary" type="button" >Buscar Examen</button>
                  </div>
              </form>         
          </div>
      </div>    
      <div class="row p-3 mb-2 bg-info text-dark">
          <div class="col-md-12 col-lg-4 mx-auto">
              <form action="">                                                       
                ...
                <div class="d-grid gap-2 d-md-block">
                    <button class="btn btn-primary" type="button" >Mostrar</button>
